...
import { CircleUser, Home, LineChart, Menu, Package, ShoppingCart, Users } from "lucide-react";
...
export default function NavBar(){
    ...
    return (<header className="flex h-14 items-center gap-4 border-b bg-muted/40 px-4 lg:h-[60px] lg:px-6">
            ...
            <SheetContent side="left" className="flex flex-col">
              ...
              <div className="flex flex-col gap-2 text-lg font-medium">
                ...
                <Link href="/" className="flex items-center text-lg  md:text-2xl  font-semibold text-foreground">
                    ...
                    <span className="sr-only">FileMe</span>
                </Link>
          ...
          <div className="w-full flex-1"><SearchBar/></div>
